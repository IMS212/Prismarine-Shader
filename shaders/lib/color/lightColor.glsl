...
vec3 cloudUpSun   = CalcSunColor(cloudUpMorning, cloudUpDay, cloudUpEvening);
vec3 cloudDownSun = CalcSunColor(cloudDownMorning, cloudDownDay, cloudDownEvening);
...
vec3 cloudUpCol   = CalcLightColor(cloudUpSun, cloudUpNight, weatherCol.rgb);
vec3 cloudDownCol = CalcLightColor(cloudDownSun, cloudDownNight, weatherCol.rgb);
